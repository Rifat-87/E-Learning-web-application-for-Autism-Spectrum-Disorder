	...
	<div class="section section-login">
		...
		<div class="se-lo-main">
			<div class="section container-fluid pt5 pb5">
              ...
              <h1 style="font-size: 3rem; font-weight: bold;" class="co-blue-2">Feedback </h1>
							<div class="mt4">
								<form action="feedbacksend.php" method="POST">
									<div class="form-group">
										<input class="form-control com_input" type="text" name="Name" value="" placeholder="Name">
									</div>
									<div class="form-group">
										<input class="form-control com_input" type="text" name="Email" value="" placeholder="Email">
                  </div>
                  <div class="form-group">
										<input class="form-control com_input" type="text" name="Feedback" value="" placeholder="Comment">
									</div>
									<div class="form-group">
